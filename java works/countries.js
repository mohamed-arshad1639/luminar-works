...
//     cntryData={countryName,population,capital,currency}
...
//     // console.log(`CountryNmae ${countryName} population ${population} Capital ${capital} currency ${currency}`);
// }
// // console.log(count);

 //country name more than 20000000

//  countries.filter(data=>data.population>2000000).map(cntry=>cntry.countryName).forEach(nm=>console.log(nm));
